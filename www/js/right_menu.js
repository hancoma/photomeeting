...
function view_mypage() {
  ...
  var uuid=device.uuid;
    ...
    $.post("http://photomeeting.net/my_info_app.php",
   {
    uuid:uuid,
    memberuid:memberuid
...
function view_msg() {
  var uuid=device.uuid;
    ...
    $.post("http://photomeeting.net/my_message_app.php",
   {
    uuid:uuid,
    memberuid:memberuid
...
function join_msg_box(room_no,by_uid) {
  ...
  console.log(room_no+" "+memberuid);
    ...
    $.post("http://photomeeting.net/my_message_room_app.php",
   {
    room_no:room_no,
    memberuid:memberuid,
    by_uid:by_uid
...
function view_view_list() {
  var uuid=device.uuid;
    ...
    $.post("http://photomeeting.net/my_view_list_app.php",
   {
    uuid:uuid,
    memberuid:memberuid
...
function delete_view(no) {
  var no=no;
   $.post("http://photomeeting.net/delete_view.php",
   {
    no:no
...
function view_picked_member() {
  var uuid=device.uuid;
    ...
    $.post("http://photomeeting.net/my_pickedmember_app.php",
   {
    uuid:uuid,
    memberuid:memberuid
...
function view_picked_me() {
  var uuid=device.uuid;
    ...
    $.post("http://photomeeting.net/my_pickedme_app.php",
   {
    uuid:uuid
...
function view_photo_upload() {
  var uuid=device.uuid;
    ...
    $.post("http://photomeeting.net/my_photoupload_app.php",
   {
    uuid:uuid,
    memberuid:memberuid
...
function view_change_password() {
  var uuid=device.uuid;
    ...
    $.post("http://photomeeting.net/my_changepassword_app.php",
   {
    uuid:uuid
...
function save_password() {
  ...
  if (new_password!=new_password2) {
   ...
   $.post("http://photomeeting.net/save_password_app.php",
   {
   memberuid:memberuid,
...
function view_membershipwithdrawal() {
  var uuid=device.uuid;
    ...
    $.post("http://photomeeting.net/membershipwithdrawal_app.php",
   {
    uuid:uuid
...
function view_premium_service() {
  var uuid=device.uuid;
    ...
    $.post("http://photomeeting.net/premium_service_app.php",
   {
    uuid:uuid
...
function view_terms() {
  var uuid=device.uuid;
    ...
    $.post("http://photomeeting.net/term_app.php",
   {
    uuid:uuid
...
function view_membershipwithdrawal() {
   var uuid=device.uuid;
    ...
    $.post("http://photomeeting.net/member_out.php",
   {
    uuid:uuid
...
function view_setup() {
  var uuid=device.uuid;
    ...
    $.post("http://photomeeting.net/setup_app.php",
   {
    uuid:uuid
