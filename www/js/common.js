...
function load_left() {
    $.post("http://photomeeting.net/left_menu_app.php",
   {
...
function load_right() {
    $.post("http://photomeeting.net/right_menu_app.php",
   {
...
function main_rand_show() {
 var cat=cat;
  ...
  $("#map").hide();
  $("#top_banner").show();
 $.post("http://photomeeting.net/main_rand_app.php",
   {
    cat:cat
...
function main_show() {
 ...
 $.post("http://photomeeting.net/map_api_app.php",
   {
    mode:mode
...
function talent_show(cat) {
  ...
  $("#map").hide();
  $("#top_banner").show();
 $.post("http://photomeeting.net/talent_list_app.php",
   {
    cat:cat
...
function freeboard_show(cat) {
 ...
 $.post("http://photomeeting.net/freeboard_list_app.php",
   {
    cat:cat
...
function parade_show(cat) {
  ...
  $("#top_banner").show();
  $("#top_banner").html("freeboard");
 $.post("http://photomeeting.net/parade_list_app.php",
   {
    cat:cat
...
function chat_job_show(cat) {
  ...
  $("#top_banner").show();
  $("#top_banner").html("freeboard");
 $.post("http://photomeeting.net/chat_job_app.php",
   {
    sub_code:cat,
    memberuid:memberuid
...
function chat_show() {
  ...
  $("#top_banner").show();
   ...
   $.post("http://photomeeting.net/chat_app.php",
   {
...
function friend_show() {
 ...
 mode="around";
  ...
  $("#company_list").height("100%");
   $.post("http://photomeeting.net/around_list_app.php",
   {
...
function global_show(sub_code) {
  ...
  $("#top_banner").show();
  mode="global";
   $.post("http://photomeeting.net/global_list_app.php",
   {
    sub_code:sub_code
...
function more_global() {
  ...
  console.log(last_no);
    $.post("http://photomeeting.net/more_global_list_app.php",
   {
    last_no:last_no,
    sub_code:sub_code
...
function premium_show(sub_code) {
  ...
  if (sub_code==1) {
    var url="http://photomeeting.net/premium1_app.php";
  }
  if (sub_code==2) {
    var url="http://photomeeting.net/premium2_app.php";
  }
  if (sub_code==3) {
    var url="http://photomeeting.net/premium3_app.php";
  }
  if (sub_code==4) {
    var url="http://photomeeting.net/premium4_app.php";
  }
...
function map_show(kind_no) {
  ...
  mode="main";
  $("#company_list").height("100%");
  var url="http://photomeeting.net/map_api_app.php";
  UIkit.offcanvas.hide('#offcanvas-left');
   $.post(url,
   {
    kind_no:kind_no
...
function more_map_api(last_no) {
  var last_no=last_no;
  var url="http://photomeeting.net/map_api_more_app.php";
...
function contents_modal_show(menu,no) {
    ...
    console.log(menu+" "+no);
    if (menu=="talent") {
      var url="http://photomeeting.net/talent_info_modal_app.php";
    }
    if (menu=="freeboard") {
      var url="http://photomeeting.net/freeboard_info_modal_app.php";
    }
if (menu=="parade") {
      var url="http://photomeeting.net/parade_info_modal_app.php";
    }
...
function member_info_modal_show(memberuid) {
  var memberuid=memberuid;
    $.post("http://photomeeting.net/member_info_modal_app.php",
   {
    no:memberuid
...
function open_shop(no) {
  var no=no;
    $.post("http://photomeeting.net/shop_info_modal_app.php",
   {
    no:no
...
function zzim_member(uid) {
  ...
  console.log(memberuid+" "+uid2);
   $.post("http://photomeeting.net/add_zzim.php",
   {
    uid:memberuid,
    uid2:uid2
   },
...
function msg_send(uid,msg) {
  ...
  var by_uid=uid;
  var msg=msg;
    $.post("http://photomeeting.net/msg_save_app.php",
   {
    my_uid:my_uid,
    by_uid:by_uid,
    msg:msg
...
function add_talent(cat) {
  ...
  console.log("category="+cat)
    $.post("http://photomeeting.net/self_camera_app.php",
   {
    memberuid:memberuid,
    cat:cat
...
function add_freeboard(cat) {
  var cat=cat;
  console.log("category="+cat)
    $.post("http://photomeeting.net/freeboard_app.php",
   {
    memberuid:memberuid,
    cat:cat
...
function add_parade(cat) {
  var cat=cat;
  console.log("category="+cat)
    $.post("http://photomeeting.net/parade_app.php",
   {
    memberuid:memberuid,
    cat:cat
...
function file_check(no) {
  var no=no;
  console.log(no);
  $.post("http://photomeeting.net/file_check_app.php",
   {
    memberuid:memberuid,
    no:no
...
function file_delete(no) {
  var no=no;
  console.log(no);
  $.post("http://photomeeting.net/file_delete_app.php",
   {
    memberuid:memberuid,
    no:no
 ...
 function delete_comment(mode,no,no2) {
  ...
  $.post("http://photomeeting.net/delete_comment_app.php",
   {
    mode:mode,
    no:no
...
function delete_contents(mode,no) {
	...
	var no=no;
	console.log(mode+" "+no);
	$.post("http://photomeeting.net/delete_contents_app.php",
   {
    mode:mode,
    no:no
