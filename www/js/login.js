...
function login_press(user_id,password) {
    ...
    var password=password;
     ...
     $.post("http://photomeeting.net/login_check.php",
   {
    user_id:user_id,
    password:password
   ...
   function(data){
    ...
    // 회원 memberuid 가져오기
        ...
        console.log(user_id);
               $.post("http://photomeeting.net/login_check_uid.php",
               {
                user_id:user_id
                   },
               function(data){
...
$("#join_btn").click(
 ...
 $.post("http://photomeeting.net/join_app_form.php",
   {
...
$("#join_submit").click(
    ...
    jQuery.ajax({
        url: 'http://m.photomeeting.net/member_save.php',
        type: 'POST',
        data:params,
